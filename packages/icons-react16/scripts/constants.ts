...
export const RichComponentDirectory = "src/generated-rich-icon-components";
export const RichIconsSVGsDirectory = "./node_modules/@hopper-ui/svg-icons/dist/rich-icons/";
export const RichIconSizes = [24, 32, 40] as const;
export const RichIconSuffix = "RichIcon";
